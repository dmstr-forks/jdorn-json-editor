...
Fork of the inactive [jdorn/json-editor](https://github.com/jdorn/json-editor) using the updated fork [dmstr-forks/jdorn-json-editor](https://github.com/dmstr-forks/jdorn-json-editor). Some pull requests added from the original repo.
